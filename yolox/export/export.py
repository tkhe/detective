...
def main():
    cfg = Config.fromstring("_base_ = ['mmyolo::yolox/yolox_tiny_fast_8xb32-300e-rtmdet-hyp_coco.py']", file_format=".py")
    model = MODELS.build(cfg.model)
    model.eval()

    load_checkpoint(model, "yolox_tiny_fast_8xb32-300e-rtmdet-hyp_coco_20230210_143637-4c338102.pth", map_location="cpu")
